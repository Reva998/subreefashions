...
public AccountDetails(String account_number, String username, String ifsc, String upi_id, String bankname,
...
public String toString() {
	return "AccountDetails [account_number=" + account_number + ", username=" + username + ", ifsc=" + ifsc
