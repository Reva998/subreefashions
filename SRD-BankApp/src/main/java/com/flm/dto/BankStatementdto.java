...
public class BankStatementdto {
	...
	public BankStatementdto(String transid, String account_number, String upi_id, String sender_upi, int amount,
	...
	public String toString() {
		return "BankStatementdto [transid=" + transid + ", account_number=" + account_number + ", upi_id=" + upi_id
